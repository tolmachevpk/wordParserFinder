/****************************************************************************
** Meta object code from reading C++ file 'lookForMatchesThread.h'
**
...
#error "The header file 'lookForMatchesThread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 10), // "foundWords"
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::foundWords)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::startCalculating)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::foundWords(QString _t1)
{
...
// SIGNAL 1
void WorkerThread::startCalculating()
{
